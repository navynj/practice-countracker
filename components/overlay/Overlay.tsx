      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            <motion.div
              className={cn(
                `absolute bottom-0 w-full p-8 rounded-tl-3xl rounded-tr-3xl bg-white shadow-[0_4px_60px_0_rgba(99,99,99,0.2)] lg:shadow-none`,
                fromTop ? 'top-0 bottom-auto rounded-[0_0_1.5rem_1.5rem]' : '',
                className,
                isLg
                  ? 'max-w-120 w-full left-[50%] -translate-x-[50%] -translate-y-[25%] rounded-3xl'
                  : ''
              )}
              layout
              initial={{
